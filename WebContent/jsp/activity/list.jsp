...
<div class="container">
	...
	<% for(Activity activity : activities) { %>
		<div class="d-flex justify-content-lg-evenly shadow p-3 mb-4 bg-light text-dark rounded-3">
	...
	<%} else { %>
	<div class="p-4 sm-3">
		<p class="text-center fw-light fst-italic">Vous n'avez pas encore créé d'activité. <a href="activity?s=add" class="link-primary">CLiquez ici</a> pour en créer une.</p>
	</div>
	<%} %>
</div>